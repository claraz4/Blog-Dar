...
export default function BlogBoxAll({ blog }) {
  ...
  return (
    <Link
      className="blog-box--container blog-box-all--container"
      state={{ blog }}
      to="/blog"
    >
      <div
        className="blog-box--img blog-box-all--img"
        style={{
      ...
      <div className="blog-box--info-post blog-box-all--info-post">
        <div>
          ...
          >
            <div>
              <p className="blog-box-category blog-box-all-category">
                {category}
              </p>
            ...
            <div className="likes--container">
              ...
              <span
                className={`material-symbols-rounded thumb-up${
                  user && blog.dislikedby.includes(user.id)
                    ? " thumb--clicked"
                    : ""
                }`}
